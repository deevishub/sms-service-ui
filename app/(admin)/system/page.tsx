...
export default function AdminSystem() {
  const serviceChecks = [
    ...
    {
      service: "DLT Validator",
      status: "degraded",
      detail: "template cache warmup",
    },
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-6">
          ...
          <div className="rounded-lg border border-orange-200 dark:border-orange-900 bg-orange-50 dark:bg-orange-950 p-4">
            <p className="text-sm font-semibold text-orange-900 dark:text-orange-200">
              Bulk queue lag spike
            </p>
            <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
              Detected at 11:05 IST. Auto-throttle enabled, worker autoscale in
              progress.
            </p>
              ...
              {queueMetrics.map((queue) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 text-zinc-700 dark:text-zinc-300">
                    {queue.lag.toLocaleString("en-IN")}
                  </td>
                  <td className="px-6 py-3 text-zinc-700 dark:text-zinc-300">
                    {queue.throughputPerSecond}/s
                  </td>
